...
DESCRIPTION="GDB for RISC-V (by Espressif)"
HOMEPAGE="https://github.com/espressif/binutils-gdb"
SRC_URI="https://github.com/espressif/binutils-gdb/releases/download/esp-gdb-v${MY_PV}/riscv32-esp-elf-gdb-${MY_PV}-x86_64-linux-gnu.tar.gz"

S="${WORKDIR}/riscv32-esp-elf-gdb"
...
EOF
	newenvd "${T}/env" 99gdb-riscv32-esp-elf-bin
}
