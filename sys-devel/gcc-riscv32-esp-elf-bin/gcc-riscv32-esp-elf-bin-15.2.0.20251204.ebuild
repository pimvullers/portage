...
DESCRIPTION="GCC for RISC-V (crosstool-NG with support for Xtensa)"
HOMEPAGE="https://github.com/espressif/crosstool-NG"
SRC_URI="https://github.com/espressif/crosstool-NG/releases/download/esp-${MY_PV}/riscv32-esp-elf-${MY_PV}-x86_64-linux-gnu.tar.xz"

S="${WORKDIR}/riscv32-esp-elf"
...
EOF
	newenvd "${T}/env" 99gcc-riscv32-esp-elf-bin
}
