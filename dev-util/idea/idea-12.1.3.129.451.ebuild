...
if [[ "${VER[4]}" == "0" ]]; then
    SRC_URI="http://download.jetbrains.com/${PN}/${PN}IC-$(get_version_component_range 1-2).tar.gz"
else
    SRC_URI="http://download.jetbrains.com/${PN}/${PN}IC-$(get_version_component_range 1-3).tar.gz"
fi
